...
pdf.set_font('Arial', 'B', 12)
pdf.set_text_color(0, 0, 0)  # Preto
titulo_mes_atual = f'Feminicídios - Comparativo por dia no mês de referência (até ontem): {mes_ontem}/{ano_ontem}'
...
pdf.set_font('Arial', 'B', 12)
pdf.set_text_color(0, 0, 0)  # Preto
titulo_por_dia = f'Feminicídios comparativo por dia no mês de referência (até ontem) :'
...
pdf.set_font('Arial', 'B', 12)
pdf.set_text_color(0, 0, 0)
titulo_mes_regiao = f'Feminicídios por dia por Região no mês de referência (até ontem): {mes_ontem}/{ano_ontem}'
